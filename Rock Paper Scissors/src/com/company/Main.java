...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Choose rock, paper, or scissors. Type 'r' for rock, 'p' for paper, and 's' and for scissors.");
        ...
        //If anything other than 'r', 's', or, 'p' is inputted, an error message will popup telling you to play again
            ...
            System.out.println("Oops, invalid selection, please play again.");
        }
    }
}
